...
$db_host 		= 	"10.169.0.12"; 	// MySQL Host Name.
$db_user 		= 	"moodkiec_es2"; 		// MySQL User Name.
$db_password 	= 	"moodkie230lbftZetec"; 	// MySQL Password.
$db_name 		= 	"moodkiec_es2"; 			// MySQL Database Name.
