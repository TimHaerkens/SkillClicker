...
namespace Devdog.InventorySystem.Demo
{
    ...
    public partial class MyCustomMonster : MonoBehaviour, IObjectTriggerUser
    {
        ...
        public void Start()
        {
            ...
            triggerer.window = new UIWindowField() { window = InventoryManager.instance.loot.window };
        ...
        {          
            ...
            if (character != null)
                dmg = 40 + (int)character.stats.Get("Default", "Strength").currentValue;
            else
                dmg = 40;
        ...
        protected virtual IEnumerator SinkIntoGround()
        {
            ...
            if (InventoryManager.instance.selectableObjectInfo.currentSelectableObject == selectableObjectInfo)
                selectableObjectInfo.UnSelect(InventoryPlayerManager.instance.currentPlayer);
