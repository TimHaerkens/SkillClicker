...
namespace Devdog.InventorySystem.Editors
{
    ...
    public class UIWindowEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(showAudioClip, true);
            EditorGUILayout.PropertyField(hideAudioClip, true);

            bool clicked = DrawConvertButton(t);
            if (clicked) return;
        ...
        protected virtual bool DrawConvertButton(UIWindow t)
        {
            if (GUILayout.Button("Convert to interactive window"))
            {
                t.gameObject.AddComponent<UIWindowInteractive>();
                DestroyImmediate(t);
