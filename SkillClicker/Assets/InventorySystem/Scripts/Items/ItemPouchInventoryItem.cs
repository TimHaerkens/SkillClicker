    ...
    public partial class ItemPouchInventoryItem : InventoryItemBase, IInventoryItemContainer
    {
        ...
        public override int Use()
        {
            ...
            if (itemCollection != null && InventoryManager.IsInventoryCollection(itemCollection) == false)
            {
                ...
                bool added = itemCollection.RemoveItemsThenAdd(items, new InventoryItemAmountRow(this, 1));
                if (added == false)
                {
            ...
            {
                bool added = InventoryManager.RemoveItemsThenAdd(items, new InventoryItemAmountRow(this, 1));
                if (added == false)
                {
